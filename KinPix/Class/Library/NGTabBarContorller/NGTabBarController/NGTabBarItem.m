...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        _badgeTextFont = [UIFont fontWithName:@"Arial-BoldMT" size:10.0];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.image != nil)
    {
        ...
        if ([[self badgeValue] length])
        {
            ...
            CGSize badgeSize = CGSizeMake(11,11);
        
            CGRect badgeBackgroundFrame = CGRectMake(36.0,
                                                     textOffset + [self badgePositionAdjustment].vertical + 2,
            ...
            if (NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_6_1)
            {
                ...
                [[self badgeValue] drawInRect:CGRectMake(CGRectGetMinX(badgeBackgroundFrame) + textOffset,
                                                         ...
                                                         badgeBackgroundFrame.size.width - textOffset - 1, badgeBackgroundFrame.size.height - textOffset )
