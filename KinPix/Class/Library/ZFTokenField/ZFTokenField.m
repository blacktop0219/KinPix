...
{    
    ...
    if (!self.textField)
    {
        ...
        self.textField.font = [AppDelegate getAppSystemFont:12.f];
        self.textField.placeholder = @"Tags";
...
- (void)reloadData
{
    ...
    self.textField.frame = (CGRect) {0,0,75,[self.dataSource lineHeightForTokenInField:self]};
